...
* librtpkcs11ecp.so for the architectures: `armv7a` and `arm64`.
...
1. Before building the project, copy the downloaded external dependencies to the
   directory `external/pkcs11ecp/android-<arch>/lib/`, where `<arch>` is the library architecture. Files location
