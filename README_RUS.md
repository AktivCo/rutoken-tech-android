...
* Мобильные бригады — для демонстрации сценария работы бригады с устройствами Рутокен на одном мобильном устройстве. В
  разделе можно подписать один или несколько документов одной или несколькими электронными подписями, также можно
  посмотреть список подписавших и поделиться подписанным документом.
...
Приложение "Рутокен Технологии" собирается с использованием Android SDK Platform 35 и новее и запускается на устройствах
...
Для работы в разделах Банк и Мобильные бригады на устройстве линейки Рутокен ЭЦП необходимо иметь ключевую пару и сертификат. Если
их нет, то для тестовых целей создать их можно в разделе Удостоверяющий центр мобильного приложения. Или на настольном
компьютере выполнить следующие действия:
