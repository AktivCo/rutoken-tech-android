        ...
        viewModelScope.launch(Dispatchers.IO) {
            ...
            sessionHolder.setSession(
                BankUserLoginAppSession(
                    // This value is always equal to the zero, because the actual user ID is generated by SQLite, but we
                    // don't use it in any Bank scenarios with a logged user, so it doesn't matter.
